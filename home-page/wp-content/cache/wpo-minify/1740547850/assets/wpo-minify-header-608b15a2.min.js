  ...
  jQuery(document).ready(function ($) {
    ...
    const handleChangeColor = {
      change: function (event, ui) {
        ...
        const colorPickerId = $(this)
          .closest(".wpsaio-app-input-wrap")
          .data("appname");
        // change code
        if (colorPickerId && colorPickerId.match(/\d+/)) {
      ...
      file_frame.on("select", function () {
        ...
        selection.each(function (attachment) {
          ...
          if (attachment.id) {
            ...
            const classSuffix = $(target)
              .attr("id")
              .replace("wpsaio_button_", "")
              .replace("_icon", "")
              .replaceAll("_", "-");
            const imageClass = classPrefix + classSuffix;

            $(imageClass).html(
              '<img src="' + file_choosed + '" alt="Image Preview">'
            );
